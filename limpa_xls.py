...
while int(loop) == 0:
    ...
    if int(a) == 1:
        programa = " Legacy 500"
        file_xls = "C://Users//MEHONOR//Desktop//PA_Leg500.xls"
        file_xlsx = "C://Users//MEHONOR//Desktop//PA_Leg500.xlsx"
    elif int(a) == 2:
        programa = " Legacy 650"
        file_xls = "C://Users//MEHONOR//Desktop//PA_Leg650.xls"
        file_xlsx = "C://Users//MEHONOR//Desktop//PA_Leg650.xlsx"
    elif int(a) == 3:
        programa = " Phenom 100"
        file_xls = "C://Users//MEHONOR//Desktop//PA_Ph100.xls"
        file_xlsx = "C://Users//MEHONOR//Desktop//PA_Ph100.xlsx"
    elif int(a) == 4:
        programa = " Phenom 300"
        file_xls = "C://Users//MEHONOR//Desktop//PA_Ph300.xls"
        file_xlsx = "C://Users//MEHONOR//Desktop//PA_Ph300.xlsx"
    elif int(a) == 5:
        programa = " Lineage"
        file_xls = "C://Users//MEHONOR//Desktop//PA_Lineage1000.xls"
        file_xlsx = "C://Users//MEHONOR//Desktop//PA_Lineage1000.xlsx"
    else:
    ...
    if ticket == 1:    
        ...
        for i in range(0,2):
            ...
            for line in range(1, row_count):
                for column1 in range(1, column_count):
                    if line == 1:
